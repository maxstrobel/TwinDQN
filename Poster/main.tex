...
\begin{columns}
    ...
    \block{Our Idea}{
    	...
    	{\includegraphics[width=.3\textwidth]{movement.png}};
    	\end{tikzpicture}
    }
    \block{Preprocessing \& Environment}{
    	...
    	{\includegraphics[width=.3\textwidth]{preprocessing_pipeline.png}};
    	\end{tikzpicture}
	    \newline
	    \newline
    ...
    \block{Proposed Architecture}{
    	\begin{tikzpicture}
		\node[inner sep=0pt] (Architecture1) at (0,0)
    	{\includegraphics[width=.3\textwidth]{two_nets.png}};
    	\end{tikzpicture}
    	\newline
	    \newline
    ...
    \block{Visualization}{
    	...
    	{\includegraphics[width=.3\textwidth]{filter_breakout.png}};
    	\end{tikzpicture}	
    	\begin{tikzpicture}
		\node[inner sep=0pt] (filter_breakout) at (0,0)
    	{\includegraphics[width=.3\textwidth]{filter_spaceinvaders.png}};
    	\end{tikzpicture}
		\newline
		The above pictures show the convolution filters of the first layer of the subnets.
		The top right picture, for example, shows the velocity and the position of the ball.
   	}   	
    ...
    \block{Results}{
		...
		\begin{tabular}{ | l | c c c|}
			...
			\hline
			Breakout + SpaceInvaders (Random) 	& (7.4, 45.1) &  (1.1, 1.1) & (6.3, 44.0) \\
			Breakout + SpaceInvaders (Twin DQN) & (,) &  (,) & (,) \\ \hline
			Phoenix + SpaceInvaders (Random) 	& (,) & (,) & (,)\\
    	...
    	{\includegraphics[width=.3\textwidth]{training.png}};
    	\end{tikzpicture}
    	[1]: (Mnih et al. 2015)
	}
\end{columns}
