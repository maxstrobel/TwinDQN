...
\begin{columns}
    ...
    \block{Results}{
		...
		evaluated the Twin DQN on 1000 episodes with a frameskip of 4 and a probability of 0.01 to take a random action instead of the action selected by the network.
		\newline
		\newline
		\begin{tikzpicture}
