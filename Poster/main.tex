...
\begin{tabular}{ l | c c c}
	...
	Phoenix + SpaceInvaders & (24.9, 640.5) & (42.9, 1605.8) & (,)\\
\end{tabular}
The first element of the tuple is the clamped reward which was used for training, second one the actual, unclamped reward.
